...
public class QuestCompletedMessage
{
	...
	public static void encode(final QuestCompletedMessage msg, final PacketBuffer packetBuffer)
	{
		packetBuffer.writeEnum(msg.sourceMod);
		packetBuffer.writeLong(msg.questID);
	}

	public static QuestCompletedMessage decode(final PacketBuffer packetBuffer)
	{
